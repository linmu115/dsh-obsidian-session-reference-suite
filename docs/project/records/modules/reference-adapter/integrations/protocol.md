...
sources:
- path: ../../../dsh-obsidian-reference-adapter/src/protocol.ts
...
源码入口：[protocol.ts](../../../../../../../dsh-obsidian-reference-adapter/src/protocol.ts)、[annotation-consumer.ts](../../../../../../../dsh-obsidian-reference-adapter/src/client/annotation-consumer.ts)、[obsidian-source-adapter.ts](../../../../../../../dsh-obsidian-reference-adapter/src/host/obsidian-source-adapter.ts)。
