...
变更任何身份映射时，同时查 [Core 添加/解除入口](../modules/annotation-core/interfaces/client.md)、[Companion 领取合同](../modules/obsidian-companion/interfaces/references.md) 和 [目录镜像映射](../dependencies/session-maintenance/core-directory-consumer.md)。
