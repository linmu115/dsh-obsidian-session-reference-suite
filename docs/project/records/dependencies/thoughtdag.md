...
ThoughtDAG 项目 ID 为 9b066b81-bb0e-4c2a-b528-56c24499f886，消费说明 IF-suite-consumer 由该独立地图维护。独立地图源码核对说明其使用 Core 的 addCrossSessionReference、prepareGraphReferences、resolveReferenceLink / deleteReferenceLink、openAnnotationInSession，以及 Maintenance 的图领域服务，不属于本组合七成员。
